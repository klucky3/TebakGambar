...
public class InjakJasActivity extends Activity {
	//Deklarasi Activity
		EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_injak_jas);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.injak_jas, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	String jawabanBenar = "INJAK GAS";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), Jasa_MurahActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
