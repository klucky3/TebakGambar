...
public class Kurang_AjarActivity extends Activity {
	//Deklarasi Activity
		EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_kurang__ajar);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kurang__ajar, menu);
		return true;
	}
	
	public void cekJawaban(View v){
    	String jawabanBenar = "KURANG AJAR";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(), Muka_TembokActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
