...
public class Jasa_MurahActivity extends Activity {
	//Deklarasi Activity
			EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_jasa__murah);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.jasa__murah, menu);
		return true;
	}
		 public void cekJawaban(View v){
		    	String jawabanBenar = "JASA MURAH";
		    	...
		    	if(jawabanUser.equals(jawabanBenar)){
		    		...
		    		Intent i = new Intent(getApplicationContext(), Keramik_LantaiActivity.class);
		    		startActivity(i);
		    	}
		    	else{
		    		//Pesan Text
