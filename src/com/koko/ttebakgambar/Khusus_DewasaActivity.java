...
public class Khusus_DewasaActivity extends Activity {
	//Deklarasi Activity
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_khusus__dewasa);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.khusus__dewasa, menu);
		return true;
	}
	
	 public void cekJawaban(View v){
	    	String jawabanBenar = "KHUSUS DEWASA";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), Ko_otomatisActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
