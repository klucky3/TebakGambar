...
public class Ko_otomatisActivity extends Activity {
	//Deklarasi Activity
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_ko_otomatis);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.ko_otomatis, menu);
		return true;
	}
	
	 public void cekJawaban(View v){
	    	String jawabanBenar = "KOREKSI OTOMATIS";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), KomposisiActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
