...
public class KomposisiActivity extends Activity {
	//Deklarasi Activity
	EditText jawabanTxt;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.komposisi, menu);
		return true;
	}
	 public void cekJawaban(View v){
	    	String jawabanBenar = "KOMPOSISI CAIRAN";
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), Kopi_AlamiActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
