...
public class Kopi_AlamiActivity extends Activity {
	//Deklarasi Activity
	EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_kopi__alami);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.kopi__alami, menu);
		return true;
	}

	public void cekJawaban(View v){
    	String jawabanBenar = "KOPI ALAMI";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(), Kurang_AjarActivity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
