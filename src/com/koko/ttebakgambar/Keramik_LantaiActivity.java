...
public class Keramik_LantaiActivity extends Activity {
	//Deklarasi Activity
			EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_keramik__lantai);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.keramik__lantai, menu);
		return true;
	}
	 ...
	 public void cekJawaban(View v){
	    	...
	    	if(jawabanUser.equals(jawabanBenar)){
	    		...
	    		Intent i = new Intent(getApplicationContext(), Khusus_DewasaActivity.class);
	    		startActivity(i);
	    	}
	    	else{
	    		//Pesan Text
