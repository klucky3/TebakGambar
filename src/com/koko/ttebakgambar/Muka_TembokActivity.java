...
public class Muka_TembokActivity extends Activity {
	//Deklarasi Activity
		EditText jawabanTxt;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_muka__tembok);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.muka__tembok, menu);
		return true;
	}
	
	public void cekJawaban(View v){
    	String jawabanBenar = "MUKA TEMBOK";
    	...
    	if(jawabanUser.equals(jawabanBenar)){
    		...
    		Intent i = new Intent(getApplicationContext(), Menang_Activity.class);
    		startActivity(i);
    	}
    	else{
    		//Pesan Text
